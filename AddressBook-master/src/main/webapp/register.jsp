            ...
            <div class="container">
                <div class="col-md-6 offset-md-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form">
                                <form action="RegisterUserServlet" method="POST" id="RegisterUser" >
                                    <div class="form-row">
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="email" maxlength="50" name="email" class="form-control" id="validationDefault01" placeholder="email" required>
                                        </div>
                                    </div>
                                    <div class="form-row">
                                            <div class="col-md-4 mb-3">
                                    ...
                                    <center>
                                        <button class="btn btn-primary" style="align-items: center!important" type="submit">Register</button>
                                    </center>
                                </form>
                            </div>
